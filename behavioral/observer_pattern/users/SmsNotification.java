...
public class SmsNotification implements UserNotificationInterface {
    StockNotifierInterface notifier;
    String user_name;

    public SmsNotification(String user_name, StockNotifierInterface notifier){
    ...
    public void updateUser(){
        System.out.println("SMS sent to User: "+user_name+" for the stock of "+notifier.getStockName());
    }
}
